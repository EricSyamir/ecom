<?php
// ini adalah paparan maklumat penjual 
include('db.php');
?>
<?php  
$server="localhost";
...
<header class="w3-container w3-xlarge">
  <p class="w3-left w3-text-brown" style="font-size:xx-large">Maklumat Penjual</p>
  <p class="w3-right"></p>
</header>
<!-- content -->
  ...
  <div class="panel-body">
    <div class="table-responsive">
      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <div>
          <a href="delete.php" class="txt1" style="color: blue">
          Padam Penjual
        </a>
      </div>
    </div>
