...
<header class="w3-container w3-xlarge">
  <p class="w3-left w3-text-brown" style="font-size:xx-large">Import Produk</p>
  <p class="w3-right"></p>
</header>
<!-- content -->
  ...
  <div class="panel-body">
    <div class="table-responsive">
      ...
      <form method="POST" action="processimport.php" enctype="multipart/form-data">
        ...
        <button type="submit" name="import" class="btn btn-primary btn-sm">Import produk</button>
      </form>
      <?php
