<?php
// ini adalah paparan log masuk pengguna 
session_start();  
...
<div class="limiter">
	...
	<div class="wrap-input100 validate-input" data-validate="KataLaluan diperlukan">
		<input class="input100" style="background-color:white" type="text" name="pass">
		<span class="focus-input100"></span>
		<span class="label-input100" style="color:grey">Masukkan KataLaluan</span>
	</div>
	<div class="flex-sb-m w-full p-t-3 p-b-32">
		<div>
			<a href="loginseller.php" class="txt1" style="color: blue">
			Anda bukan pengguna? Log Masuk Penjual
		</a>
	</div>
</div>
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$sql = "SELECT IDPengguna FROM pengguna WHERE IDPengguna = '$myusername' and KataLaluan = '$mypassword'";
	...
	if($count == 1) {
		...
		echo '<script>alert("IDPengguna atau KataLaluan tidak sah") </script>' ;
