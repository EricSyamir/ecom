<?php
// ini adalah paparan menu utama pengguna
include('db.php');
?>
<!DOCTYPE html>
<html>
...
Produk <i class="fa fa-caret-down"></i></a>
<div id="demoAcc" class="w3-bar-block w3-hide w3-padding-large w3-medium">
  <a href="#products" class="w3-bar-item w3-button w3-text-brown"><i class="fa fa-caret-right w3-margin-right"></i>Botol air </a>
</div>
...
<header class="w3-container w3-xlarge">
    <p class="w3-left w3-text-brown" style="font-size:xx-large">Botol Air </p>
...
<div class="w3-display-container w3-container">
  ...
  <h1 class="w3-jumbo w3-hide-small w3-text-brown">Mari Beli !</h1>
  ...
  <div class="w3-col l3 s6">
    <div class="w3-container" href="/F4/login/loginuser.php">
      <div class="w3-display-container" >
        ...
        <div class="w3-display-middle w3-display-hover" href="/F4/login/products/product1.php">
          <button class="w3-button w3-white w3-text-brown" ><a href="products/product1.php">Beli sekarang <i class="fa fa-shopping-cart"></a></i></button>
        </div>
      </div>
    ...
    <div class="w3-container">
      <div class="w3-display-container">
        ...
        <div class="w3-display-middle w3-display-hover" >
          <button class="w3-button w3-white w3-text-brown"><a href="/F4/login/products/product2.php">Beli sekarang <i class="fa fa-shopping-cart"></a></i></button>
        </div>
      </div>
  ...
  <div class="w3-col l3 s6">
    <div class="w3-container">
      <div class="w3-display-container">
        ...
        <div class="w3-display-middle w3-display-hover">
          <button class="w3-button w3-white w3-text-brown"><a href="/F4/login/products/product3.php">Beli sekarang <i class="fa fa-shopping-cart"></a></i></button>
        </div>
      </div>
    ...
    <div class="w3-container">
      <div class="w3-display-container">
        ...
        <span class="w3-tag w3-display-topleft w3-green">Popular !</span>
        <div class="w3-display-middle w3-display-hover">
          <button class="w3-button w3-white w3-text-brown"><a href="/F4/login/products/product4.php">Beli sekarang <i class="fa fa-shopping-cart"></a></i></button>
        </div>
      </div>
  ...
  <div class="w3-col l3 s6">
    <div class="w3-container">
      <div class="w3-display-container">
        ...
        <div class="w3-display-middle w3-display-hover">
          <button class="w3-button w3-white w3-text-brown"><a href="/F4/login/products/product5.php">Beli sekarang <i class="fa fa-shopping-cart"></a></i></button>
        </div>
      </div>
    ...
    <div class="w3-container">
      <div class="w3-display-container">
        ...
        <span class="w3-tag w3-display-topleft w3-blue">Terkini !</span>
        <div class="w3-display-middle w3-display-hover">
          <button class="w3-button w3-white w3-text-brown"><a href="/F4/login/products/product6.php">Beli sekarang <i class="fa fa-shopping-cart"></a></i></button>
        </div>
      </div>
  ...
  <div class="w3-col l3 s6">
    <div class="w3-container">
      <div class="w3-display-container">
        ...
        <div class="w3-display-middle w3-display-hover">
          <button class="w3-button w3-white w3-text-brown"><a href="/F4/login/products/product7.php">Beli sekarang <i class="fa fa-shopping-cart"></a></i></button>
        </div>
      </div>
    ...
    <div class="w3-container">
      <div class="w3-display-container">
        ...
        <span class="w3-tag w3-display-topleft w3-red">Terhad !</span>
        <div class="w3-display-middle w3-display-hover">
          <button class="w3-button w3-white w3-text-brown"><a href="/F4/login/products/product8.php">Beli sekarang <i class="fa fa-shopping-cart"></a></i></button>
        </div>
      </div>
