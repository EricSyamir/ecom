<?php
// ini adalah paparan padam penjual 
include('db.php');
?>
<?php
$server="localhost";
...
<header class="w3-container w3-xlarge">
    <p class="w3-left w3-text-brown" style="font-size:xx-large">Padam Penjual</p>
</header>
<!-- content -->
<table>
    <form name="form" method="post">
        <tr>
            ...
            <td><select name="idpenjual"  class="form-control" required>
                <option value selected >Sila pilih IDPenjual</option>
                <?php 
                $sqli = "SELECT * FROM penjual ";
                $result = mysqli_query($con, $sqli);
                while ($row = mysqli_fetch_array($result)) {
                    # code...
                    echo '<option>'.$row['IDPenjual'].'</option>';
                }	
                ?>
                </select>
                ...
                if(isset($_POST['submit'])) {
                    ...
                    {	
                        echo '<script>alert("Data penjual telah dikemaskini") </script>' ;
                    } else {
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <div class="flex-sb-m w-full p-t-3 p-b-32">
                            <div>
                                <a href="penjual.php" class="txt1" style="color: blue">
